...
if __name__ == '__main__':
    ...
    os.system(f'./rmsnorm_v2 {args.which} {args.input_file} {args.seq_len} {embed_dim} {workdir} {layer_prefix} {args.output_file}')
    # Keep rms_inv_temp.bin for verifier to use for claimed output verification
